package com.phuong.livestreamapi.filter;

import com.auth0.jwt.JWT;
import com.auth0.jwt.JWTVerifier;
import com.auth0.jwt.algorithms.Algorithm;
import com.auth0.jwt.interfaces.DecodedJWT;
import com.phuong.livestreamapi.cookie.SameSiteHttpServletResponse;
import com.phuong.livestreamapi.model.AppUser;
import com.phuong.livestreamapi.repository.IAppUserRepository;
import com.phuong.livestreamapi.service.JwtUserDetailsService;
import com.phuong.livestreamapi.utils.ConstantUtils;
...
//    private void handleRefreshToken(Cookie refreshCookie, HttpServletRequest request, HttpServletResponse response) {
...
//                .withClaim(ConstantUtils.Authentication.ROLES, new SimpleGrantedAuthority(ConstantUtils.Authentication.ROLE_ADMIN).getAuthority())
//                .sign(algorithm);
//        Cookie accessCookieN = new Cookie(ConstantUtils.Authentication.ACCESS_TOKEN, accessToken);
